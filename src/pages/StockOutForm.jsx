...
const StockOutForm = ({ showMessage }) => {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'PartID') {
      ...
      const selectedProduct = spareParts.find(part => String(part.PartID ?? part._id ?? '') === selectedPartID);
      setFormData({
        ...formData,
  ...
  const selectedProduct = spareParts.find(part => String(part.PartID ?? part._id ?? '') === String(formData.PartID));
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Record Stock Out</h1>
              <p className="text-sm text-gray-600">Process sales and removals</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          {/* Form Header */}
          <div className="bg-gradient-to-r from-red-600 to-rose-600 px-8 py-4">
